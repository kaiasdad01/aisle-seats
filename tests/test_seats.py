...
class SeatParsingTests(unittest.TestCase):
    def test_parse_and_find_aisle_seats(self):
        payload = {
            "seats": [
                {
                    "row": 12,
        ...
        self.assertEqual([s.code for s in aisle], ["12C", "15G"])

    def test_explicit_aisle_characteristic(self):
        seat = Seat(
            row=10,
            letter="B",
            available=True,
